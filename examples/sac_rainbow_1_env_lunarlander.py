...
from rl_agents.value_functions.c51q import C51Loss, ContinuousC51QWrapper
...
def main():
    ...
    agent = ActorCriticAgent(
        ...
        trainer= SACTrainer(
            ...
            sampler = PrioritizedReplaySampler(replay_memory=replay_memory),
            gamma= GAMMA,
            q_policy=policy,
            action_space=action_space,
            init_alpha=0.1,
