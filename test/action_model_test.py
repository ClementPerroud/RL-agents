...
def test_epsilon_greedy_all_model():
    ...
    strategy = EspilonGreedyActionStrategy(q = 0.99, min_epsilon = 0.01, action_space=action_space)
...
def test_epsilon_greedy_all_random():
    ...
    proxy = EspilonGreedyActionStrategy(q = 0.99, min_epsilon = 0.01, action_space=action_space)
    proxy.epsilon = 1.0
